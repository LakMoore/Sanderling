...
internal class PythonReader
{
  ...
  internal readonly IImmutableDictionary<string, Func<ulong, object>> specializedReadingFromPythonType;
  ...
  internal PythonReader(IMemoryReader memoryReader, MemoryReadingCache cache)
  {
    ...
    specializedReadingFromPythonType =
        ImmutableDictionary<string, Func<ulong, object>>.Empty
        .Add("str", new Func<ulong, object>(ReadingFromPythonType_str))
        .Add("unicode", new Func<ulong, object>(ReadingFromPythonType_unicode))
        .Add("int", new Func<ulong, object>(ReadingFromPythonType_int))
        .Add("bool", new Func<ulong, object>(ReadingFromPythonType_bool))
        .Add("float", new Func<ulong, object>(ReadingFromPythonType_float))
        .Add("PyColor", new Func<ulong, PyColor>(ReadingFromPythonType_PyColor))
        .Add("Bunch", new Func<ulong, object>(ReadingFromPythonType_Bunch))
        /*
         ...
         * */
        .Add("Link", new Func<ulong, object>(ReadingFromPythonType_Link))
        .Add("instance", new Func<ulong, object>(ReadingFromPythonType_instance))
        .Add("dict", new Func<ulong, List<DictionaryEntry>>(ReadingFromPythonType_dict))
        .Add("long", new Func<ulong, object>(ReadingFromPythonType_long));
  }
  ...
  internal object GetDictEntryValueRepresentation(ulong valueOjectAddress)
  {
    return cache.GetDictEntryValueRepresentation(valueOjectAddress, valueOjectAddress =>
    {
      ...
      return specializedRepresentation(genericRepresentation.address);
    });
  }

  internal string ReadingFromPythonType_str(ulong address)
  {
  ...
  internal object ReadingFromPythonType_unicode(ulong address)
  {
    ...
    var stringBytes = memoryReader.ReadBytes(
  ...
  internal object ReadingFromPythonType_int(ulong address)
  {
  ...
  internal object ReadingFromPythonType_long(ulong address)
  {
    var intObjectMemory = memoryReader.ReadBytes(address, 0x18);
  ...
  internal object ReadingFromPythonType_bool(ulong address)
  {
  ...
  internal object ReadingFromPythonType_float(ulong address)
  {
    return ReadPythonFloatObjectValue(address);
  }

  internal PyColor ReadingFromPythonType_PyColor(ulong address)
  {
    var pyColorObjectMemory = memoryReader.ReadBytes(address, 0x18);
    ...
    var dictionaryEntries = GetDictionaryEntriesWithStringKeys(dictionaryAddress);
  ...
  internal object ReadingFromPythonType_Bunch(ulong address)
  {
    var dictionaryEntries = GetDictionaryEntriesWithStringKeys(address);
    ...
    foreach (var entry in dictionaryEntries)
    {
      ...
      (
          key: entry.Key,
          value: GetDictEntryValueRepresentation(entry.Value)
      ));
    }
  ...
  internal object ReadingFromPythonType_Link(ulong address)
  {
    var pythonObjectTypeName = GetPythonTypeNameFromPythonObjectAddress(address);

    var linkMemory = memoryReader.ReadBytes(address, 0x40);
    ...
    var firstDictReference =
        ...
        .Where(reference =>
        {
          var referencedObjectTypeName = GetPythonTypeNameFromPythonObjectAddress(reference);
    ...
    var dictEntries =
        GetDictionaryEntriesWithStringKeys(firstDictReference)
        ?.ToImmutableDictionary(
            keySelector: dictEntry => dictEntry.Key,
            elementSelector: dictEntry => GetDictEntryValueRepresentation(dictEntry.Value));
  ...
  internal List<DictionaryEntry> ReadingFromPythonType_dict(ulong address)
  {
  ...
  internal object ReadingFromPythonType_instance(ulong address)
  {
    ...
    return ReadingFromPythonType_dict(ma_keys);
  }
